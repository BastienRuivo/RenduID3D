...
struct TriangleData
{
    ...
    bool hasTwoCommonPoint(const TriangleData & other) const {
        int count = 0;
        if(other.a.x >= a.x - EPSILON && other.a.x <= a.x + EPSILON && other.a.y >= a.y - EPSILON && other.a.y <= a.y + EPSILON && other.a.z >= a.z - EPSILON && other.a.z <= a.z + EPSILON) count++;
        if(other.b.x >= a.x - EPSILON && other.b.x <= a.x + EPSILON && other.b.y >= a.y - EPSILON && other.b.y <= a.y + EPSILON && other.b.z >= a.z - EPSILON && other.b.z <= a.z + EPSILON) count++;
        if(other.c.x >= a.x - EPSILON && other.c.x <= a.x + EPSILON && other.c.y >= a.y - EPSILON && other.c.y <= a.y + EPSILON && other.c.z >= a.z - EPSILON && other.c.z <= a.z + EPSILON) count++;

        if(other.a.x >= b.x - EPSILON && other.a.x <= b.x + EPSILON && other.a.y >= b.y - EPSILON && other.a.y <= b.y + EPSILON && other.a.z >= b.z - EPSILON && other.a.z <= b.z + EPSILON) count++;
        if(other.b.x >= b.x - EPSILON && other.b.x <= b.x + EPSILON && other.b.y >= b.y - EPSILON && other.b.y <= b.y + EPSILON && other.b.z >= b.z - EPSILON && other.b.z <= b.z + EPSILON) count++;
        if(other.c.x >= b.x - EPSILON && other.c.x <= b.x + EPSILON && other.c.y >= b.y - EPSILON && other.c.y <= b.y + EPSILON && other.c.z >= b.z - EPSILON && other.c.z <= b.z + EPSILON) count++;

        if(other.a.x >= c.x - EPSILON && other.a.x <= c.x + EPSILON && other.a.y >= c.y - EPSILON && other.a.y <= c.y + EPSILON && other.a.z >= c.z - EPSILON && other.a.z <= c.z + EPSILON) count++;
        if(other.b.x >= c.x - EPSILON && other.b.x <= c.x + EPSILON && other.b.y >= c.y - EPSILON && other.b.y <= c.y + EPSILON && other.b.z >= c.z - EPSILON && other.b.z <= c.z + EPSILON) count++;
        if(other.c.x >= c.x - EPSILON && other.c.x <= c.x + EPSILON && other.c.y >= c.y - EPSILON && other.c.y <= c.y + EPSILON && other.c.z >= c.z - EPSILON && other.c.z <= c.z + EPSILON) count++;
...
struct TriangleGroup
{
    ...
    Point min, max;    //!< boite englobante du groupe
};
...
public:
    ...
    */
    ...
    int triangle_index( const unsigned int id , int sid) const {
        return m_indices[id*3+sid];
    }
    ...
    void bounds(int is, int ie, Point & pmin, Point & pmax) const;
    ...
    //! renvoie l'adresse de la tangente du premier sommet. par convention, la tangente est un vec3, 3 GL_FLOAT.
    const float *tangent_buffer( ) const { return &m_tangents.front().x; }
    //! renvoie la longueur (en octets) du tangent buffer.
    std::size_t tangent_buffer_size( ) const { return m_tangents.size() * sizeof(vec3); }
